...
<header class="page-header text-white py-5">
	<div class="container">
		<h1 class="display-5 fw-bold mb-3">
			<span class="material-icons display-4 align-middle me-3">flag</span>
			Getting Started
		</h1>
		<p class="lead mb-0">Step-by-step guide to set up your BoomStick development environment.</p>
	</div>
</header>
...
<main class="container my-5">
	...
	<div class="alert alert-info mb-4">
		...
		<strong>Choose your module name.</strong> "<code>bang</code>" is used throughout these instructions. Replace "<code>bang</code>" with whatever you choose as your module name in ALL commands.
	</div>
				...
				<div class="card step-card h-100">
					<div class="card-body">
						<div class="d-flex align-items-start">
							...
							<div class="ms-3 flex-grow-1">
								<h5 class="card-title">Initialize the Entry Module</h5>
								<p class="card-text text-muted">Run the initialization script to create the NginX configuration for your entry module.</p>
								<div class="code-block-wrapper">
									<pre class="code-block"><code>cd module/entry-bang && ./entry-init.sh && cd ../../</code></pre>
									<button class="copy-btn" title="Copy to clipboard"><span class="material-icons">content_copy</span></button>
								</div>
							</div>
						</div>
